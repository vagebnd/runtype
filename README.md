...
[![GitHub Tests Action Status](https://img.shields.io/github/workflow/status/vagebnd/runtype/run-tests.yml?label=tests)](https://github.com/vagebnd/runtype/actions?query=workflow%3Arun-tests+branch%3Amain)
